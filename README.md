<h1 align="center">Joseph Javier Sánchez Acuña</h1>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Plotly%2FDash-3F4F75?style=for-the-badge&logo=plotly&logoColor=white" />
...
|---|---|---|
| 🎓 **[Tesis-Paper-Code](https://github.com/GIUSEPPESAN21/Tesis-Paper-Code)** | Paquete de reproducibilidad de tesis de maestría: *Graph Neural Networks + PPO* para *dynamic flexible job-shop scheduling* bajo perturbaciones estocásticas. Checkpoints entrenados, 752 tests, resultados E0–E8, Docker y archivo en Zenodo. | `PyTorch` `Stable-Baselines3` `GNN` `OR-Tools CP-SAT` `Gymnasium` |
| ⛏️ **[ore_hauling_simheuristics](https://github.com/GIUSEPPESAN21/ore_hauling_simheuristics)** | Código de un paper para *International Journal of Mining, Science and Technology*: tres simheurísticas (SimTSI-MC, SimTSI-DES, DynSimTSI-DES) para optimizar el acarreo de mineral con Tabu Search calibrado + simulación Monte Carlo / eventos discretos. | `Python` `Tabu Search` `Discrete-Event Simulation` |
| 📈 **[Forecasting](https://github.com/GIUSEPPESAN21/Forecasting)** | Motor de pronósticos de demanda con clasificación estructural automática, validación *walk-forward* sin fuga de datos, intervalos de predicción y política de inventario derivada. 266 tests, dashboard interactivo en Dash. | `Python` `Dash/Plotly` `Prophet` `LightGBM` |
| 🚚 **[ACO-MetaHeuristica-Improvements](https://github.com/GIUSEPPESAN21/ACO-MetaHeuristica-Improvements)** | Aplicación web interactiva para resolver el *Capacitated Vehicle Routing Problem (CVRP)* con Ant Colony Optimization, visualización de rutas en mapa y monitoreo del algoritmo en tiempo real. | `Python` `Streamlit` `ACO` |
| 🩺 **[SaludIA-Uniandes-Uniminuto](https://github.com/GIUSEPPESAN21/SaludIA-Uniandes-Uniminuto)** | Sistema de soporte a decisiones clínicas para monitoreo domiciliario: motor de reglas determinista (ACC/AHA, ADA, WHO, NEWS2) con capa opcional de explicación en lenguaje natural vía Gemini. 55 tests unitarios. | `Python` `Streamlit` `Firebase` `Gemini API` |
| 🧠 **[Grafo-Interactivo](https://github.com/GIUSEPPESAN21/Grafo-Interactivo)** | Mapa de conocimiento interactivo (79 temas, 12 categorías, 99 relaciones de prerrequisito) para aprender Claude desde cero hasta desarrollo profesional con la API. | `Next.js` `TypeScript` `Streamlit` |
...
<p align="center"><i>"Diseñando algoritmos que deciden mejor, para que las personas decidan más."</i></p>
